...
class BenchDataset:
    ...
    def _validate_args(self, args):
        ...
        if args.mode_parameter:
            assert self.mode_parameter.startswith('week') or self.mode_parameter in self.commonnames, 'mode_parameter error'        
    ...
    def _validate_input_directory(self):
        ...
        if not self.save_dir.exists():
            assert self.save_dir.exists(), f'save directory does not , creating save directory: {args.save_dir}'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, dest="mode", default="random", help="'random', 'by_week', 'by_commonname', or 'choas'")
    parser.add_argument("--mode_parameter", type=str, dest="mode_parameter", default=None, help="If mode is 'by_week', give week info (ie 'week1'). If mode is 'commonname', give commonname.")
